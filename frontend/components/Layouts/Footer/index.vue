        ...
        <div class="row">
          <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
            <div class="contact-form btm-brdr">
              <div class="form-Box">
                <input type="submit" value="Logo" class="fill-btn" />
              </div>
            </div>
          </div>
          <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
            <div class="contact-address btm-brdr">
              ...
              <ul>
                ...
                <li> <i class="fa fa-map-marker" aria-hidden="true"></i> <span>121 Abc St, France, Madagascar</span> </li>
                <li><i class="fa fa-envelope-o" aria-hidden="true"></i><span>info@test.com</span></li>
              </ul>
            </div>
          </div>
        <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
